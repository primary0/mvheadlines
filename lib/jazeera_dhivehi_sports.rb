class JazeeraDhivehiSports < NewsAgency
  ...
  def get_pages
    begin
      @news_page = Hpricot(open('http://www.jazeera.com.mv/categories/view/2'))
      true
    rescue
    ...
    begin
      ...
      begin
        ...
        link['post_type'] = 'sports'
	      ...
	      log_error("#{name} - Sports", "Unable to extract headline")
      end
      ...
      begin
	      ...
	      log_error("#{name} - Sports", "Unable to extract sub news")
      end
